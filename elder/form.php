...
<p id="bmi" name="bmi" style="width:200px; height:40px; background-color:white;  border-radius: 5px; border:2px solid #FBE6C2; padding-top:8px; padding-bottom:8px; padding-right:2px; color:black;" maxlength="5"></p>
            ...
            <div class="row">
                ...
                <div class="mb-3 col-3" id="hba1cDiv"  style="display:block;">
                    ...
                    <input required type="number" class="form-control w-75" name="HbA1c" id="HbA1c" autocomplete="off" min="4"  max="16" onchange="errorCheck();">
                ...
                <div id="egfrDiv" class="mb-3 col-3 " style="display:block;">
                    ...
                    <input required type="number" class="form-control w-75" name="egrf" id="egrf"  onkeypress="return isNumberKey(event)" maxlength="2" autocomplete="off" onchange="errorCheck();">

                </div>
                <div id="creatinineDiv" class="mb-3 col-3 " style="display:block;">
                    <label for="creatinine" class="form-label">Creatinine :</label>
                    <input required type="text" class="form-control w-75" name="creatinine" id="creatinine" min="0.1" max="15"  maxlength="4" autocomplete="off"  onchange="errorCheck();">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-3" id="triglycaridDiv" style="display:block;" >
                    ...
                    <input required type="number" class="form-control w-75" name="triglycerides" id="triglycerides" autocomplete="off" min="50"  max="5000" onkeypress="return isNumberKey(event)" onchange="errorCheck();">
                ...
                <div class="mb-3 col-3" id="hdlDiv" style="display:block;" >
                    ...
                    <input required type="number" class="form-control w-75 " name="hdl" id="hdl" autocomplete="off" onkeypress="return isNumberKey(event)" min="20"  max="300" onchange="errorCheck();">
                ...
                <div id="ldlDiv" class="mb-3 col-3 " style="display:block;">
                    ...
                    <input required type="number" class="form-control w-75" name="ldl" id="ldl" min="30"  max="250"  onkeypress="return isNumberKey(event)" maxlength="3" autocomplete="off" onchange="errorCheck();">
                ...
                <div id="cholesterolDiv" class="mb-3 col-3 " style="display:block;">
                    ...
                    <input required type="number" class="form-control w-75" name="cholesterol" id="cholesterol" min="50" max="500"  maxlength="3" autocomplete="off" onchange="errorCheck();">
            ...
            <div class="row">
                <div class="mb-3 col-3 ">
                    <label for="hb" class="form-label"> HB
                        :</label>
                    <input required type="number" class="form-control w-75" name="hb" id="p1" min="0"  max="18" onkeypress="return isNumberKey(event)" maxlength="2" autocomplete="off"  onchange="errorCheck();">
                ...
                <div class="mb-3 col-3" style="display:block;">
                 ...
                 <select required name="feces" id="p2" class="form-select w-75 form-control"  required>
                     <option value="">--اختر--</option>
                ...
                <div class="mb-3 col-3" id="hbacDiv"  style="display:block;">
                    ...
                    <select required  name="sight" id="p3" class="form-select w-75 form-control"  required>
                        <option value="">--اختر--</option>
                ...
                <div class="mb-3 col-3" id="hba cDiv"  style="display:block;">
                   ...
                   <select required name="teeth" id="p4" class="form-select w-75 form-control"  required>
                        <option value="">--اختر--</option>
            ...
            <div class="row">
                <div class="mb-3 col-3 ">
                    ...
                    <select required  name="heart" id="p5" class="form-select w-75 form-control"  required>
                        <option value="">--اختر--</option>
                ...
                <div class="mb-3 col-3" id="hbacDiv"  style="display:block;">
                    ...
                    <select required  name="cog" id="p6" class="form-select w-75 form-control" required >
                        <option value="">--اختر--</option>
                        <option value="طبيعى" >طبيعي</option>
                ...
                <div class="mb-3 col-3" id="hbacDiv"  style="display:block;">
                    ...
                    <select required  name="gds" id="p7" class="form-select w-75 form-control" required >
                        <option value="">--اختر--</option>
                ...
                <div class="mb-3 col-3" id="hbacDiv"  style="display:block;">
                    ...
                    <select required  name="must" id="p8" class="form-select w-75 form-control"  required>
                        <option value="">--اختر--</option>
            ...
            <div class="row">
                <div class="mb-3 col-3" id="xrayDiv"  style="display:block;">
                    ...
                    <select required  name="xray" id="p9" class="form-select w-75 form-control" onchange="message(); checkGender1();" required>
                        <option value="">--اختر--</option>
                        <option value="نعم" >طبيعي</option>
                        <option value="لا">غير طبيعي</option>
                        <option value="لم يتم">لم يتم </option>
...
<section class="container">
    ...
    <select required name="country" id="country" class="form-select w-75 form-control" >
