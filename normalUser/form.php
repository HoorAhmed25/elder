     ...
     <h4 class="container-fluid headOfPersonal mb-2 pb-2" > التاريخ الطبـى (هل يوجد)   
        ...
        <div class="form-container-rep text-right pr-3" style="background-color:#eeeeee;">
            <div class="row pt-2 mb-4">
             <div  class="mb-3 col-3">
    <label for="diabetes" class="form-label"> إصابة بمرض السكر :</label>
    <select required name="diabetes" id="diabetes" class="form-select w-75 form-control" onchange="Check()">
      <option value=" "  >--اختر--</option>
       <option value="نعم" >نعم</option>
         <option value="لا">لا</option>
    </select> 
               ...
               <div  class="mb-3 col-3">
    <label for="bloodpressure" class="form-label">إصابة بمرض ضغط الدم :</label>
    <select required name="bloodpressure" id="bloodpressure" class="form-select w-75 form-control" onchange=" Check()" >
      <option value=" ">--اختر--</option>
       <option value="نعم" >نعم</option>
         <option value="لا">لا</option>
    </select>     
             ...
             <div  class="mb-3 col-3">
    <label for="heartdisease" class="form-label">إصابة بأمراض القلب :</label>
    <select required name="heartdisease" id="heartdisease" class="form-select w-75 form-control" >
      <option value=" ">--اختر--</option>
       <option value="نعم" >نعم</option>
         <option value="لا">لا</option>
    </select>  
...
<div  class="mb-3 col-3">
    <label for="smoking" class="form-label">التدخين :</label>
    <select required name="smoking" id="smoking" class="form-select w-75 form-control" onchange="checkAll();">
      <option value="  ">--اختر--</option>
       <option value="مدخن" >مدخن</option>
         <option value="غير مدخن">غير مدخن</option>
         <option value="مدخن سابق">مدخن سابق</option>
     ...
     <h4 class="container-fluid headOfPersonal mb-2 pb-2" > التاريخ الطبـى (هل يوجد)   
        ...
        <div class="form-container-rep text-right pr-3" style="background-color:#eeeeee;">
            <div class="row pt-2 mb-4">
             <div  class="mb-3 col-3">
    <label for="diabetes" class="form-label"> إصابة بمرض السكر :</label>
    <select required name="diabetes" id="diabetes" class="form-select w-75 form-control" onfocus="noneDiabetes();" onchange="Check()">
      <option value=" "  >--اختر--</option>
       <option value="نعم" >نعم</option>
         <option value="لا">لا</option>
    </select> 
