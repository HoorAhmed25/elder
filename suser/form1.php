...
?>
    ...
    <select name="diabetes" id="diabetes" class="form-select w-75 form-control" onfocus="noneDiabetes();" onchange="Check()" required>
    ...
    <select name="heartdisease" id="heartdisease" class="form-select w-75 form-control" required>
      <option value="">--اختر--</option>
       <option value="نعم" >نعم</option>
         <option value="لا">لا</option>
    </select>  
...
<div  class="mb-3 col-3">
    ...
    <select name="smoking" id="smoking" class="form-select w-75 form-control" onchange="checkAll();" required>
      <option value="">--اختر--</option>
